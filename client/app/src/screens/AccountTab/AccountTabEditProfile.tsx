...
export const AccountTabEditProfile: FC<AccountTabEditProfileProp> = (
  props: AccountTabEditProfileProp,
) => {
  ...
  const showNotification = (value: string) => {
    dispatch(showSuccessNotification(value));
  };
  ...
  }, [profileState, _accountService, showNotification, navigation]);
  ...
  const components = [
    {
      ...
      onChangeText: (value: string) => {
        setProfileState({...profileState, lastName: value});
      },
      containerStyle: {},
    },
    {
      ...
      label: 'Tên',
      onChangeText: (value: string) => {
        setProfileState({...profileState, firstName: value});
      },
      containerStyle: {},
    },
    {
    ...
    },
    {
      ...
      label: 'Số điện thoại',
      onChangeText: (value: string) => {
        setProfileState({...profileState, phoneNumber: value});
      },
      containerStyle: {},
    },
    {
      ...
      label: 'Địa chỉ 1',
      onChangeText: (value: string) => {
        setProfileState({...profileState, addressLine1: value});
      },
      containerStyle: {},
    },
    {
      ...
      label: 'Địa chỉ 2',
      onChangeText: (value: string) => {
        setProfileState({...profileState, addressLine2: value});
      },
      containerStyle: {},
    },
  ];
  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <AddressModal
        ...
        iconOnPress={() => {
          setProfileState({...profileState, addressModalVisible: false});
        }}
        modalOnPress={(data) => {
          setProfileState({
            ...profileState,
...
const SNKGKTextInput: FC<SNKGKTextInputProp> = (props: SNKGKTextInputProp) => {
  ...
  return (
    <Input
      ...
      inputContainerStyle={textInputStyles.inputContainerStyle}
      containerStyle={[textInputStyles.containerStyle, containerStyle]}
      label={label}
...
export const SNKGKPickerRow: FC<SNKGKPickerRowProp> = (
  props: SNKGKPickerRowProp,
) => {
  ...
  return (
    <TouchableOpacity
      ...
      <AppText.SubHeadline>{title}</AppText.SubHeadline>
...
export const AddressModal: FC<AddressModalProp> = (props: AddressModalProp) => {
  const {
    addressModalVisible,
    onRequestClose,
    iconOnPress,
