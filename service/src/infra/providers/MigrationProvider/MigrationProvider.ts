...
import { Migration_07272021, Migration_08242021 } from "../../migrations";
...
export class MigrationProvider {
  ...
  @inject(Migration_08242021.name)
  private migration_08242021: Migration_08242021;

  public run(): Promise<any> {
    const migrations = [
      this.migration_1624492681744.run(),
      this.migration_072721.run(),
      this.migration_08242021.run(),
    ];
